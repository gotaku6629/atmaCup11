...
def objective(trial):
    ...
    class CFG:
        ...
        #     'bagging_fraction': trial.suggest_uniform('bagging_fraction', 0.80, 1.0),
        #     'early_stopping_round': 20,
        #     'bagging_freq': trial.suggest_int('bagging_greq', 1, 3),
        ...
        # }
        params = {
            'alpha': trial.suggest_uniform('alpha', 0.001, 100),  # Ridge, Lasso
    ...
    class LGBMModel():
        ...
        def fit(self, X_train, y_train, X_val, y_val):
            ...
            verbose_eval = True if self.params['verbosity']>0 else False
