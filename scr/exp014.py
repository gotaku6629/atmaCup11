...
class CFG:
    ...
    size=224
    scheduler='OneCycleLR' # 'ReduceLROnPlateau', 'CosineAnnealingLR', 'CosineAnnealingWarmRestarts', GradualWarmupSchedulerV2
    epochs=25
    multi_gpu = False 
    ...
    scheduler_params = {'lr_start': 7.5e-6, 'min_lr': 1e-6, 'lr_max': 1.5625e-5*batch_size*num_gpu if multi_gpu else 1.5625e-5*batch_size }
